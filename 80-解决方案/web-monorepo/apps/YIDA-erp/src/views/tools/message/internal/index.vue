			...
			<el-table-column label="操作" width="300">
				<template #default="scope">
					<el-button
						...
						text
						type="primary"
						@click="contentRef.openDialog(scope.row)"
						>详情
					</el-button>
					<el-button
						icon="BellFilled"
...
const NewsContent = defineAsyncComponent(
	() => import('/@/views/home/news/content.vue')
);
// 定义查询字典
