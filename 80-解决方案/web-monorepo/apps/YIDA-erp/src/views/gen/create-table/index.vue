	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					<el-button
						...
						@click="
							formDialogRef.openDialog('add', null, state.queryForm.dsName)
						"
					>
						{{ $t('common.addBtn') }}
					</el-button>
			...
			>
				...
				<el-table-column
					prop="tableName"
					:label="t('createTable.tableName')"
					show-overflow-tooltip
				/>
				<el-table-column
					prop="comments"
					:label="t('createTable.comments')"
					show-overflow-tooltip
				/>
				<el-table-column
					prop="primary"
				...
				>
					<template #default="scope">
						<!--  获取主键列名称-->
						{{
							JSON.parse(scope.row.columnInfo).find((col) => col.primary === 1)
								?.name
						}}
					</template>
				</el-table-column>
				<el-table-column
					prop="createTime"
					:label="t('createTable.createTime')"
					show-overflow-tooltip
				/>
