...
import { getOtherOutboundChooseSku } from '/@/api/warehouse/otherStock/outStock/index';
...
const state: BasicTableProps = reactive<BasicTableProps>({
	queryForm: {},
	pageList: getOtherOutboundChooseSku,
	createdIsNeed: false,
...
const handleOpen = () => {
	// 根据 warehouseType 切换接口
	state.pageList =
		props.warehouseType === '3'
			? getChooseSkuByOtherbound
			: getOtherOutboundChooseSku;
	// 重置查询
	state.queryForm = {
	...
	>
        ...
        "
			...
			>
				...
				<!-- <el-table-column :label="t('可用数量')" min-width="100" show-overflow-tooltip>
					<template #default="{ row }">
						{{ row.qty || '---' }}
					</template>
				</el-table-column> -->
