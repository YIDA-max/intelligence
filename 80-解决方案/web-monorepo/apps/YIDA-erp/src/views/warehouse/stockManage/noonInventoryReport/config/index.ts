...
import {
	NOON_TEMPLATE_URL,
	NOON_IMPORT_URL,
	getNoonInventoryReportPage,
	postNoonInventoryReportExport,
} from '/@/api/warehouse/stockManage/noonInventoryReport/index';
import { productInfoSku } from '/@/views/integrations/components/tableRouteConfig';

export const importConfig = {
	TEMPLATE_URL: NOON_TEMPLATE_URL,
	IMPORT_URL: NOON_IMPORT_URL,
};

export const moduleKey = 'stockManage_noonInventoryReport';

export const listApi = {
	getList: getNoonInventoryReportPage as (
		_params?: any
	) => Promise<IPageListResponse>,
	exportList: postNoonInventoryReportExport,
};
