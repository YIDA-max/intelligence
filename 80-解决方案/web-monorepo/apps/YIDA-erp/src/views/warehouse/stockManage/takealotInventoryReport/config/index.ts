...
import {
	getTakealotInventoryReportPage,
	postTakealotInventoryReportExport,
	TAKEALOT_TEMPLATE_URL,
	TAKEALOT_IMPORT_URL,
} from '/@/api/warehouse/stockManage/takealotInventoryReport/index';
import { productInfoSku } from '/@/views/integrations/components/tableRouteConfig';

export const moduleKey = 'stockManage_takealotInventoryReport';

export const importConfig = {
	TEMPLATE_URL: TAKEALOT_TEMPLATE_URL,
	IMPORT_URL: TAKEALOT_IMPORT_URL,
};

export const listApi = {
	getList: getTakealotInventoryReportPage as (
		_params?: any
	) => Promise<IPageListResponse>,
	exportList: postTakealotInventoryReportExport,
};
