	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="ml10" v-show="showSearch">
				...
				>
					<el-form-item :label="$t('trade.orderId')" prop="orderId">
						<el-input
							:placeholder="t('trade.inputOrderIdTip')"
					...
					<el-form-item :label="t('trade.status')" prop="status">
						<el-select
							:placeholder="t('trade.inputStatusTip')"
			...
			>
				...
				/>
				<el-table-column
					:label="t('trade.orderId')"
					prop="orderId"
					show-overflow-tooltip
					width="120"
				/>
				<el-table-column
					:label="t('trade.channelId')"
					prop="channelId"
					show-overflow-tooltip
					width="120"
				/>
				<el-table-column
					:label="t('trade.channelMchId')"
					prop="channelMchId"
					show-overflow-tooltip
					width="120"
				/>
				<el-table-column
					:label="t('trade.channelOrderNo')"
					prop="channelOrderNo"
					show-overflow-tooltip
					width="120"
				/>
