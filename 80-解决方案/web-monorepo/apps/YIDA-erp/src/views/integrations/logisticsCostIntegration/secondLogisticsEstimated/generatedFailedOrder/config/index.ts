...
import {
	...
	generateSecondLogisticsEstimatedBill,
...
export const listApi = {
	...
	generateList: generateSecondLogisticsEstimatedBill,
};
...
const columns: Columns = [
	...
	// 生成失败额外字段
	{ title: '失败原因', field: 'failedReason', width: 250 },
	{ title: '生成失败时间', field: 'failedTime', width: 250 },
];

const moduleKey =
	'logisticsCostIntegrationSecondLogisticsEstimated_generatedFailedOrder';
