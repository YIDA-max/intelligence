 ...
 * @LastEditTime: 2026-02-11 15:50:00
	...
	<div class="layout-padding">
		<el-tabs v-model="activeName" type="border-card">
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('stockinGoods_notGeneratedOrder_view')"
			>
				<NotGeneratedOrder
			...
			<el-tab-pane
				...
				name="generatedOrder"
				:style="{ height: '100%' }"
				v-if="auth('stockinGoods_generatedOrder_view')"
			>
			...
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('stockinGoods_generatedFailedOrder_view')"
			>
...
import { getStockinGoodsPage } from '/@/api/integrations/shippingIntegration/stockinGoods/index';
