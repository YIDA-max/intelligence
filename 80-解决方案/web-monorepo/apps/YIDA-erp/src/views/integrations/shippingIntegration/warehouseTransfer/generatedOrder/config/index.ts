import {
	getWarehouseTransferShipPage,
	postExportWarehouseTransferShip,
} from '/@/api/integrations/shippingIntegration/warehouseTransfer/index';
import {
	stockOrgRelation,
...
export const listApi = {
	getList: getWarehouseTransferShipPage,
	exportList: postExportWarehouseTransferShip,
};
export const searchConfig = [
	...
	},
	{
		...
		props: {
			...
			settings: {
				text: '金蝶调入库存组织',
				code: 'kingdeeInInventoryOrgCodes', // 金蝶调入仓库编码
			},
		},
	},
	{
		...
		props: {
			...
			settings: {
				text: '金蝶调出库存组织',
				code: 'kingdeeOutInventoryOrgCodes', // 金蝶调出仓库编码
			},
		},
	},
	{
		...
		props: {
			searchTypes: [
				...
				{
					label: '金蝶单据号',
					value: 'generateKingdeeDocNos', // 金蝶单据号
				},
			],
		},
	},
			...
			searchTypes: [
				{
					...
					isAddHMS: true,
					dateStart: 'actualDeliveryDateStart', // 实际发货日期-开始
					dateEnd: 'actualDeliveryDateEnd', // 实际发货日期-结束
				},
				{
					label: '集成数据创建时间', //接口缺失
					value: 'createTime',
				...
				},
				{
					...
					isAddHMS: true,
					dateStart: 'generateKingdeeDocTimeStart', //集成数据创建时间-开始
					dateEnd: 'generateKingdeeDocTimeEnd', // 集成数据创建时间-结束
				},
			],
		},
	},
...
const columns = [
	...
	{
		title: '实际发货日期',
		field: 'actualDeliveryDate', // 实际发货日期
		width: 150,
	},
	{
		title: 'SKU',
	...
	{
		title: '发货数量',
		field: 'shipmentQuantity', // 发货数量
		width: 150,
	},
	{
		title: '发货箱数',
		field: 'deliveryCartonQuantity', // 发货箱数
		width: 150,
	},
	{
		title: '调出仓编码',
	...
	{
		title: '调出仓名称',
		field: 'takeOutWarehouseName', // 调出仓名称
		width: 150,
	},
	{
		title: '调入仓编码',
	...
	{
		title: '调入仓名称',
		field: 'takeInWarehouseName', // 调入仓名称
		width: 150,
	},
	{
		title: '金蝶物料编码',
	...
	{
		title: '金蝶单据名称',
		field: 'generateKingdeeDocName', // 金蝶单据名称
		width: 150,
	},
	{
		title: '金蝶单据编号',
		field: 'generateKingdeeDocNo', // 金蝶单据编号
		width: 150,
	},
	{
		title: '金蝶单据生成时间',
		field: 'generateKingdeeDocTime', // 生成金蝶单据时间
		width: 150,
	},
	{
		title: '金蝶单据创建人',
		field: 'kingdeeDocCreateName', // 金蝶单据创建人名称
		width: 150,
	},
];

const moduleKey = 'warehouseTransfer_generatedOrder';
