<template>
	...
	>
		<slot>
			<!-- 可选：默认插槽内容 -->
			<el-button type="primary" :disabled="self_disabled">上传文件</el-button>
		</slot>
	</el-upload>
</template>
...
interface UploadFileProps {
	isMultiple: boolean; // 是否支持多选上传 ==> 非必传（默认为 false）
	...
	dir?: string; // 文件目录
	setImgUrl: (url: string) => void; // 新增：设置图片地址的函数
}
...
const handleHttpUpload = async (options: UploadRequestOptions) => {
	...
	try {
		...
		props.setImgUrl(data); // 调用父组件传入的函数设置图片地址
