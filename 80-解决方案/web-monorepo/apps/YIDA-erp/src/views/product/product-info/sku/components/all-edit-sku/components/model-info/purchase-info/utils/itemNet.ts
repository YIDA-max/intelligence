 ...
 * @LastEditTime: 2025-12-11 10:44:42
 * @FilePath: \qianyi-ui\src\views\product\product-info\sku\components\all-edit-sku\components\model-info\purchase-info\utils\itemNet.ts
 * @Description:
 *
 * Copyright (c) 2025 by ${git_name_email}, All Rights Reserved.
 */
type SpecField = 'itemNetWeight';
/**
 * 根据单位类型自动转换指定字段的值
 * @param {string} newVal - '1' 表示公制，'2' 表示英制
 * @param {string[]} fieldNames - 要转换的字段名数组，如 ['itemNetWeight']
