 ...
 * @Date: 2026-04-27 20:14:47
 * @LastEditors: wuyueqin wuyueqin@merach.com
 * @LastEditTime: 2026-04-28 14:22:17
 * @FilePath: \qianyi-ui\src\views\materialFlow\orderContainer\components\firstAllot\utils\form-dialog.ts
...
export const editInit = async (
	...
	if (isReady) {
		...
		shippingList.value.setTime(props.currentRow.actualLoadingTime || ''); // 实际装柜时间赋值
		// 设置装柜顺序回显 + 工厂下拉选项
		try {
			// 1) 计算表格中过滤出的不同工厂ID集合
