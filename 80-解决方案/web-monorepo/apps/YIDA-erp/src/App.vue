 ...
 * @LastEditTime: 2026-03-27 17:43:29
 * @FilePath: \qianyi-ui\src\App.vue
 * @Description: 
 * 
...
onMounted(() => {
	nextTick(() => {
		...
		if (Local.get('themeConfig')) {
			let themeConfigLocal = Local.get('themeConfig');
			themeConfigLocal.globalTitle = themeConfig.value.globalTitle; //后面会被缓存覆盖，取默认配置内容
			storesThemeConfig.setThemeConfig({
				themeConfig: themeConfigLocal,
			});
