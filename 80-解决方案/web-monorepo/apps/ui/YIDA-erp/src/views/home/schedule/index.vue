	...
	<el-drawer v-model="visible" title="日程管理" size="80%" @close="handleClose">
		<div class="layout-padding-auto layout-padding-view">
			<el-row v-show="showSearch">
				...
				>
					...
					<el-form-item :label="$t('schedule.title')" prop="title">
						<el-input
							:placeholder="t('schedule.inputTitleTip')"
			...
			>
				...
				>
					<template #default="scope">
						<dict-tag
							...
							:value="scope.row.scheduleType"
						></dict-tag>
					</template>
				</el-table-column>
				<el-table-column
					prop="scheduleState"
					:label="t('schedule.state')"
					show-overflow-tooltip
				>
					<template #default="scope">
						<dict-tag
							:options="schedule_status"
							:value="scope.row.scheduleState"
						></dict-tag>
					</template>
				</el-table-column>
				<el-table-column
				...
				<el-table-column
					prop="createBy"
					:label="t('schedule.createBy')"
					show-overflow-tooltip
				/>
				<el-table-column
					prop="createTime"
					:label="t('schedule.createTime')"
					show-overflow-tooltip
				/>
...
const { schedule_type, schedule_status } = useDict(
	'schedule_type',
	'schedule_status'
);
