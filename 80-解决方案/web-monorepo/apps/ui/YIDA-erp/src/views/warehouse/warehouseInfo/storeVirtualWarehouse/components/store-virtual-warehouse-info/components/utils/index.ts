 ...
 * @LastEditTime: 2025-11-14 18:34:44
 * @FilePath: \qianyi-ui\src\views\warehouse\warehouseInfo\storeVirtualWarehouse\components\store-virtual-warehouse-info\components\utils\index.ts
 * @Description:
 *
...
export const editInit = async (formData: any, currentData: any) => {
	formData.value = {
		...
		storeId: currentData.storeId, // 店铺/站点ID
