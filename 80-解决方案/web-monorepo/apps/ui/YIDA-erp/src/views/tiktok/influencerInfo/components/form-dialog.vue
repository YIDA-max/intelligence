		...
		<div class="dialog-container">
			<el-form :model="formData" :rules="rules" ref="formRef" label-width="80px">
				...
				<el-row class="mb18">
					<el-col :span="12">
						<el-form-item label="视频链接" prop="videoLink">
							<el-input v-model="formData.videoLink" show-word-limit placeholder="视频链接" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<el-row class="mb18">
					...
					<el-col :span="12">
						<el-form-item label="挂链店铺" prop="store">
				...
				<el-row class="mb18">
					<el-col :span="12">
						<el-form-item label="播放量" prop="viewCount">
							<el-input v-model="formData.viewCount" type="number" show-word-limit placeholder="播放量" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="点赞数" prop="likeCount">
							<el-input v-model="formData.likeCount" type="number" show-word-limit placeholder="点赞数" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row class="mb18">
					<el-col :span="12">
						<el-form-item label="评论数" prop="commentCount">
							<el-input v-model="formData.commentCount" type="number" show-word-limit placeholder="评论数" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="分享数" prop="shareCount">
							<el-input v-model="formData.shareCount" type="number" show-word-limit placeholder="分享数" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row class="mb18">
					<el-col :span="24">
						<el-form-item label="AD CODE" prop="adCode">
							<el-input v-model="formData.adCode" show-word-limit placeholder="AD CODE" />
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
import { ref } from 'vue';
import { postAddTikTokInfo, postUpdateTikTokInfo } from '/@/api/tiktok/influencerInfo/index';
...
const onSubmit = () => {
	formRef.value.validate(async (valid: boolean) => {
		if (valid) {
			let api = props.visibleType === 'edit' ? postUpdateTikTokInfo : postAddTikTokInfo;
			try {
				const res = await api({
					...
					publishDate: formData.value.publishDate, // 发布日期
					videoLink: formData.value.videoLink, // 视频链接
					...
					viewCount: formData.value.viewCount, // 播放量
					likeCount: formData.value.likeCount, // 点赞数
					commentCount: formData.value.commentCount, // 评论数
					shareCount: formData.value.shareCount, // 分享数
					adCode: formData.value.adCode, // AD CODE
					// 其他参数
					id: props.visibleType === 'edit' ? props.currentRow.id : '', // 编辑时传入ID
					cooperationId: props.visibleType === 'edit' ? props.currentRow.cooperationId : '', // 添加时传入合作ID
				});
				if (res.code === 0) {
