	...
	<el-dialog :title="form.id ? $t('common.editBtn') : $t('common.addBtn')" v-model="visible" :close-on-click-modal="false" draggable width="600">
		<el-form ref="dataFormRef" :model="form" :rules="dataRules" formDialogRef label-width="90px" v-loading="loading">
			<el-row>
				...
				<el-col :span="24" class="mb20">
					<el-form-item :label="t('area.adcode')" prop="code">
						<el-input-number v-model="form.code" :placeholder="t('area.inputAdCodeByTip')" />
					</el-form-item>
				</el-col>
...
import { getObj, addObj, putObj } from '/@/api/admin/sysArea';
...
const dataRules = ref({
	name: [
		...
		//    await validateExist(rule, value, callback, form.id != '');
		//   },
		//   trigger: 'blur',
		// },
	],
...
const handleChange = (data: string) => {
	...
	form.parentCode = dataArray[dataArray.length - 1];
};
