	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row v-show="showSearch">
				...
				>
					<el-form-item :label="$t('audit.auditName')" prop="auditName">
						<el-input
							:placeholder="t('audit.inputAuditNameTip')"
							v-model="state.queryForm.auditName"
							style="max-width: 180px"
						/>
					</el-form-item>
					<el-form-item :label="$t('audit.auditField')" prop="auditField">
						<el-input
							:placeholder="t('audit.inputAuditFieldTip')"
							v-model="state.queryForm.auditField"
							style="max-width: 180px"
						/>
					</el-form-item>
					<el-form-item :label="$t('audit.createBy')" prop="createBy">
						<el-input
							:placeholder="t('audit.inputCreateByTip')"
							v-model="state.queryForm.createBy"
							style="max-width: 180px"
						/>
					</el-form-item>
					<el-form-item>
						...
						<el-button icon="Refresh" formDialogRef @click="resetQuery">{{
							$t('common.resetBtn')
						}}</el-button>
					</el-form-item>
				</el-form>
			...
			>
				...
				<el-table-column
					prop="auditField"
					:label="$t('audit.auditField')"
					show-overflow-tooltip
				/>
				<el-table-column
					prop="beforeVal"
					:label="$t('audit.beforeVal')"
					show-overflow-tooltip
				/>
				<el-table-column
					prop="afterVal"
					:label="$t('audit.afterVal')"
					show-overflow-tooltip
				/>
				<el-table-column
					prop="createBy"
					:label="$t('audit.createBy')"
					show-overflow-tooltip
				/>
				<el-table-column
					prop="createTime"
					:label="$t('audit.createTime')"
					show-overflow-tooltip
				/>
