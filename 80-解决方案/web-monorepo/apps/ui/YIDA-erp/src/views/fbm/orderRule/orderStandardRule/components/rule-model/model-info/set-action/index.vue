...
const formData = ref<Record<string, any>>({
	tag: [],
	action: 1, // 1:物流下单成功后 2:仓库发货完成后 3:无需标发
});
// 表单引用
const formRef = ref<any>(null);
// 表单校验
const rules = ref({
	action: [{ required: true, message: '请选择发货确认方式', trigger: 'blur' }],
});
// 编辑标签
	...
	<div class="box">
		<el-form :model="formData" ref="formRef" label-width="150px" :rules="rules">
			...
			<el-row class="base-info" :gutter="20">
				<el-col :span="24">
					<el-form-item label="设定动作" prop="auto">
						<template #label>
							<span
								:style="{
									color: '#f78c8c',
						...
						<el-row style="width: 100%">
							<el-col :span="24">
								<el-radio-group v-model="formData.action">
									<el-radio :value="1" size="small">物流下单成功后</el-radio>
									<el-radio :value="2" size="small">仓库发货完成后</el-radio>
									<el-radio :value="3" size="small">无需标发</el-radio>
								</el-radio-group>
							</el-col>
						</el-row>
					</el-form-item>
