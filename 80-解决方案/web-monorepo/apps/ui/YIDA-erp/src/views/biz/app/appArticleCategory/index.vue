			...
			<el-row>
				<div class="mb8" style="width: 100%">
					<el-button
						...
						v-auth="'app_appArticleCategory_add'"
					>
						新 增
					</el-button>
					<el-button
						...
						icon="Delete"
						type="primary"
						v-auth="'app_appArticleCategory_del'"
				...
				<el-table-column label="操作" width="150">
					<template #default="scope">
						<el-button
							...
							text
							type="primary"
							v-auth="'app_appArticleCategory_edit'"
...
const exportExcel = () => {
	downBlobFile(
		'/app/appArticleCategory/export',
		state.queryForm,
		'appArticleCategory.xlsx'
	);
};
