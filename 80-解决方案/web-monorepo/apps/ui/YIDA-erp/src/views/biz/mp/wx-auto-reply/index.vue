							...
							>
								...
								>
									<template #default="scope">
										<dict-tag
											:options="dicDataRepType"
											:value="scope.row.repType"
										></dict-tag>
									</template>
								</el-table-column>
								<el-table-column
						...
						<el-tab-pane name="2" label="2">
							...
							>
								...
								>
									<template #default="scope">
										<dict-tag
											:options="dicDataReqType"
											:value="scope.row.reqType"
										></dict-tag>
									</template>
								</el-table-column>
								<el-table-column
...
const WxReply = defineAsyncComponent(
	() => import('/@/components/Wechat/wx-reply/index.vue')
);
