	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="ml10" v-show="showSearch">
				...
				>
					<el-form-item :label="$t('record.notifyId')" prop="notifyId">
						<el-input
							:placeholder="t('record.inputNotifyIdTip')"
					...
					<el-form-item :label="$t('record.orderNo')" prop="orderNo">
						<el-input
							:placeholder="t('record.inputOrderNoTip')"
							style="max-width: 180px"
			...
			>
				...
				<el-table-column
					:label="t('record.notifyId')"
					prop="notifyId"
					show-overflow-tooltip
				/>
				<el-table-column
					:label="t('record.request')"
					prop="request"
					show-overflow-tooltip
				/>
				<el-table-column
					:label="t('record.response')"
					prop="response"
					show-overflow-tooltip
				/>
				<el-table-column
					:label="t('record.orderNo')"
					prop="orderNo"
					show-overflow-tooltip
				/>
				<el-table-column
