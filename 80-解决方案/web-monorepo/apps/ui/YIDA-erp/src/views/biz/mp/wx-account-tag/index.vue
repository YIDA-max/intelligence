	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
				...
				>
					<el-form-item :label="$t('wxAccountTag.tag')" prop="tag">
						<el-input
							...
							:placeholder="t('wxAccountTag.inputTagTip')"
							style="max-width: 180px"
						/>
					</el-form-item>
					<el-form-item
						:label="$t('wxAccountTag.wxAccountAppid')"
						prop="wxAccountAppid"
					>
						<el-select
							v-model="state.queryForm.wxAccountAppid"
							:placeholder="t('wxAccountTag.inputWxAccountAppidTip')"
							clearable
						>
							<el-option
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					<el-button
						...
						type="primary"
						@click="
							formDialogRef.openDialog(null, state.queryForm.wxAccountAppid)
						"
					>
						{{ $t('common.addBtn') }}
					</el-button>
					<el-button
						v-auth="'mp_wx_account_tag_export'"
						class="ml10"
						formDialogRef
						icon="Download"
						type="primary"
					...
					<el-button plain type="primary" icon="Sort" @click="asyncTag"
						>同步</el-button
					>
					<right-toolbar
			...
			>
				...
				<el-table-column
					:label="t('wxAccountTag.index')"
					type="index"
					width="60"
				/>
				<el-table-column
					:label="t('wxAccountTag.tag')"
					prop="tag"
					show-overflow-tooltip
				/>
				<el-table-column
					:label="t('wxAccountTag.wxAccountId')"
					prop="wxAccountId"
					show-overflow-tooltip
				/>
				<el-table-column
					:label="t('wxAccountTag.wxAccountName')"
					prop="wxAccountName"
					show-overflow-tooltip
				/>
				<el-table-column
