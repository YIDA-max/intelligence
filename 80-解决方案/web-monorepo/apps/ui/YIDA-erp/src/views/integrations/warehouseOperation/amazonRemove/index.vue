	...
	<div class="layout-padding">
		<el-tabs v-model="activeName" type="border-card">
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('amazonRemove_notGeneratedOrder_view')"
			>
				<NotGeneratedOrder
			...
			<el-tab-pane
				...
				name="generatedOrder"
				:style="{ height: '100%' }"
				v-if="auth('amazonRemove_generatedOrder_view')"
			>
			...
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('amazonRemove_generatedFailedOrder_view')"
			>
...
import { getAmazonRemovePage } from '/@/api/integrations/warehouseOperation/amazonRemove/index';
// 导入组件
