 ...
 * @LastEditTime: 2026-03-12 17:43:23
	...
	<div>
		<el-tabs v-model="activeName" type="border-card">
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('shippingIntegrationOverseasLoss_notGeneratedOrder_view')"
			>
				<NotGeneratedOrder
			...
			<el-tab-pane
				...
				name="generatedOrder"
				:style="{ height: '100%' }"
				v-if="auth('shippingIntegrationOverseasLoss_generatedOrder_view')"
			>
			...
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('shippingIntegrationOverseasLoss_generatedFailedOrder_view')"
			>
				<template #label>
