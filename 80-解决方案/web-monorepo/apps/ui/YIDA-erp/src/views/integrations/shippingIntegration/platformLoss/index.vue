 ...
 * @LastEditTime: 2026-03-03 17:21:57
	...
	<div>
		<el-tabs v-model="activeName" type="border-card">
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('shippingIntegrationPlatformLoss_notGeneratedOrder_view')"
			>
				<NotGeneratedOrder
			...
			<el-tab-pane
				...
				name="generatedOrder"
				:style="{ height: '100%' }"
				v-if="auth('shippingIntegrationPlatformLoss_generatedOrder_view')"
			>
			...
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('shippingIntegrationPlatformLoss_generatedFailedOrder_view')"
			>
				<template #label>
