	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			...
			<ImportDialog
				ref="importDialogRef"
				title="导入内部客户与组织关系"
				:templateUrl="INTERNAL_CUSTOMER_ORG_RELATION_IMPORT_TEMPLATE_URL"
				:excelUploadApi="INTERNAL_CUSTOMER_ORG_RELATION_IMPORT_URL"
				:accept="'.xlsx,.xls'"
...
import {
	getInternalCustomerOrgRelationPage,
	INTERNAL_CUSTOMER_ORG_RELATION_IMPORT_TEMPLATE_URL,
	INTERNAL_CUSTOMER_ORG_RELATION_IMPORT_URL,
	getExportInternalCustomerOrgRelation,
	deleteInternalCustomerOrgRelation,
} from '/@/api/integrations/baseAssociationConfig/internalCustomerOrgRelation';
...
const state: BasicTableProps = reactive<BasicTableProps>({
	pageList: getInternalCustomerOrgRelationPage,
	columns,
	toolBarConfig: {
		handleRefresh: () => {
		...
		settingKey: 'internalCustomerOrgRelation',
		isShowSetting: true,
	},
...
const handleExport = async () => {
	try {
		...
		await getExportInternalCustomerOrgRelation({
			ids,
			...state.queryForm,
			ascs: state?.ascs,
			descs: state?.descs,
...
const handleDelete = async (_item: any, row: any) => {
	await deleteInternalCustomerOrgRelation({ id: row.id });
