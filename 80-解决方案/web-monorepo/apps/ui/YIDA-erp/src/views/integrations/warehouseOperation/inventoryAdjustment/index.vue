 ...
 * @Date: 2026-02-27 13:52:03
 * @LastEditors: wuyueqin wuyueqin@merach.com
 * @LastEditTime: 2026-03-03 17:22:12
 * @FilePath: \qianyi-ui\src\views\integrations\warehouseOperation\inventoryAdjustment\index.vue
	...
	<div>
		<el-tabs v-model="activeName" type="border-card">
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="
					auth('warehouseOperationInventoryAdjustment_notGeneratedOrder_view')
				"
			>
				<NotGeneratedOrder
			...
			<el-tab-pane
				...
				name="generatedOrder"
				:style="{ height: '100%' }"
				v-if="auth('warehouseOperationInventoryAdjustment_generatedOrder_view')"
			>
			...
			<el-tab-pane
				...
				v-if="
					auth(
						'warehouseOperationInventoryAdjustment_generatedFailedOrder_view'
					)
				"
			>
				<template #label>
