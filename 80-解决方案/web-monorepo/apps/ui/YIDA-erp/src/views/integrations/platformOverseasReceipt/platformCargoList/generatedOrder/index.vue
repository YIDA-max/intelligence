...
// 暂时不做
// const deleteKdBill = async () => {
// 	try {
// 		const selectedIds = register?.getSelectedIds() || [];
// 		if (selectedIds.length === 0) {
// 			useMessage().warning('请选择要删除金蝶单据的订单');
// 			return;
// 		}
// 		ElMessageBox.confirm(
// 			`确认要为选中的${selectedIds.length}条记录删除金蝶单据吗？`,
// 			'删除金蝶单据',
// 			{
...
// 			}
// 		).then(async () => {
// 			const res = await deleteKingdeeBill({
// 				ids: selectedIds,
// 			});
// 			if (res.code === 0) {
