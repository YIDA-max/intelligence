	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			...
			<ImportDialog
				ref="importDialogRef"
				title="导入产品SKU关系"
				:templateUrl="PRODUCT_SKU_RELATION_IMPORT_TEMPLATE_URL"
				:excelUploadApi="PRODUCT_SKU_RELATION_IMPORT_URL"
				:accept="'.xlsx,.xls'"
...
import {
	getProductSkuRelationPage,
	PRODUCT_SKU_RELATION_IMPORT_TEMPLATE_URL,
	PRODUCT_SKU_RELATION_IMPORT_URL,
	getExportProductSkuRelation,
	deleteProductSkuRelation,
} from '/@/api/integrations/baseAssociationConfig/productSkuRelation';
...
const state: BasicTableProps = reactive<BasicTableProps>({
	pageList: getProductSkuRelationPage,
	columns,
	toolBarConfig: {
		handleRefresh: () => {
...
const handleExport = async () => {
	try {
		...
		await getExportProductSkuRelation({
			ids,
			...state.queryForm,
			ascs: state?.ascs,
			descs: state?.descs,
...
const handleDelete = async (_item: any, row: any) => {
	await deleteProductSkuRelation({ id: row.id });
