 ...
 * @LastEditTime: 2026-03-19 18:30:47
	...
	<div class="layout-padding">
		<el-tabs v-model="activeName" type="border-card">
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('warehouseTransferReceive_notGeneratedOrder_view')"
			>
				<NotGeneratedOrder
			...
			<el-tab-pane
				...
				name="generatedOrder"
				:style="{ height: '100%' }"
				v-if="auth('warehouseTransferReceive_generatedOrder_view')"
			>
...
import { getWarehouseTransferReceiptPage } from '/@/api/integrations/receivingIntegration/warehouseTransfer/index';
