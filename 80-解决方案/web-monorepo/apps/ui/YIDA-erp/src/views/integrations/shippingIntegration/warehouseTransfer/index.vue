 ...
 * @LastEditTime: 2026-03-02 17:00:18
	...
	<div class="layout-padding">
		<el-tabs v-model="activeName" type="border-card">
			<el-tab-pane
				...
				:style="{ height: '100%' }"
				v-if="auth('warehouseTransfer_notGeneratedOrder_view')"
			>
				<NotGeneratedOrder
			...
			<el-tab-pane
				...
				name="generatedOrder"
				:style="{ height: '100%' }"
				v-if="auth('warehouseTransfer_generatedOrder_view')"
			>
...
import { getWarehouseTransferShipPage } from '/@/api/integrations/shippingIntegration/warehouseTransfer/index';
