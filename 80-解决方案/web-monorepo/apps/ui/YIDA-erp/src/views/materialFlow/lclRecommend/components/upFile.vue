<template>
	...
	>
		...
		<el-form :model="formData" ref="formRef" :inline="false" label-position="left">
			...
			<el-row class="mb18">
				<el-col :span="24">
					<el-form-item label="条码" prop="packingListAttachments">
						<upload-file
							:limit="1"
							:fileSize="20"
							@change="() => {}"
							:fileType="['zip', 'pdf', 'xlsx', 'xls', 'doc', 'docx', 'jpg', 'png']"
							v-model="formData.packingListAttachments"
							:isShowTip="false"
							:uploadFileUrl="'/admin/sys-file/upload'"
							type="simple"
							:data="{}"
			...
			<el-row class="mb18" v-if="props.currentRow?.platformChannelCode === 'Amazon'">
				<el-col :span="24">
