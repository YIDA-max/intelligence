<template>
	...
	>
		...
		<el-form :model="formData" ref="formRef" :inline="false" label-position="left">
			<el-row class="mb18">
				<el-col :span="12">
					<el-form-item label="原计划数量" prop="shipmentQuantity"> {{ props.currentRow?.shipmentQuantity }} </el-form-item>
				</el-col>
				<el-col :span="12">
			...
			<el-row class="mb18">
				<el-col :span="24">
					<el-form-item label="剩余数量" prop="remainingQuantity">
						{{ props.currentRow?.shipmentQuantity - (props.currentRow?.shippedQuantity || 0) - (formData.splitQuantity || 0) }}
					</el-form-item>
				</el-col>
			</el-row>
		</el-form>
