<template>
	...
	>
		<div class="layout-navbars-breadcrumb-user-icon" @click="onHelpManual">
			<el-icon :title="$t('帮助文档')">
				<ele-QuestionFilled />
			</el-icon>
		</div>
		<el-dropdown
		...
		>
			<span class="layout-navbars-breadcrumb-user-link">
				<img
					:src="baseURL + userInfos.user.avatar"
...
const PersonalDrawer = defineAsyncComponent(
	() => import('/@/views/admin/system/user/personal.vue')
);
...
// 帮助文档
const onHelpManual = () => {
	window.open('https://merach.feishu.cn/docx/Vzk3dGRMGoZWeHx8WnYc1CPMnPg');
};
